% To plot Fig. 7(a) from precomputed data ir_external.mat
% In the uniform range [0:0.0004:0.014]¡Á[0:0.0004:0.012], ir_external.mat records the response to external perturbation.
